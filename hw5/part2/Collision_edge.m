%% Colligion_edge funcition
function flg = Collision_edge(obj,obs,p1,p2)
...
%
% output
%  flg: if edges pass the obstacles, 1
%       else, 0
%
...
% compute the slope and the y intersept for linear equation
